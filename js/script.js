document.addEventListener("DOMContentLoaded", ()=>{
  ...
  if(hamburger && navUl){hamburger.addEventListener("click",()=>navUl.classList.toggle("active"));}
  ...
  if(form){form.addEventListener("submit",(e)=>{if(!form.checkValidity()){e.preventDefault();form.reportValidity();}else{e.preventDefault();alert("Cadastro simulado: formulário válido!");form.reset();}});}
});
